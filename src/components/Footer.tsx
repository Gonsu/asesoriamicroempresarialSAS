...
const Footer = () => (
  <footer className="bg-ame-dark-surface px-8 py-8 flex justify-between items-center flex-wrap gap-4">
    ...
    <div className="flex gap-5 flex-wrap items-center">
      <a href="https://wa.me/573168308779" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-primary-foreground/50 text-[11px] hover:text-primary transition-colors font-medium">
      ...
      <div className="flex gap-3">
        <a href="https://www.facebook.com/profile.php?id=100090527183922" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-primary-foreground/50 hover:text-primary hover:scale-110 transition-all duration-300">
          <Facebook size={16} />
        </a>
